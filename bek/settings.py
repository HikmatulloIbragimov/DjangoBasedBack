...
TELEGRAM_BOT_TOKEN = config("TELEGRAM_BOT_TOKEN_NEW")
TELEGRAM_ADMIN_ID = int(config("TELEGRAM_ADMIN_ID_NEW"))
# TELEGRAM_ADMIN_ID = 1351070481  # без кавычек, как int

CELERY_BROKER_URL = os.getenv("REDIS_URL")
CELERY_ACCEPT_CONTENT = ['json']
CELERY_TASK_SERIALIZER = 'json'
CELERY_RESULT_BACKEND = 'django-db'
CELERY_TASK_SEND_SENT_EVENT = True  # для -E
CELERY_WORKER_SEND_TASK_EVENTS = True  # для -E
print(f"[DEBUG] Загружен токен: {TELEGRAM_BOT_TOKEN}")
